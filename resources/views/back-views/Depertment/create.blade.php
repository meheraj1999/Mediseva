...
<div class="col-md-12">
    ...
    <div class="block">
        ...
        <div class="block-content">
                <form role="form" action="{{ route('depertment.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @if ($errors->any())
                ...
                <div class="form-group row">
                    <label class="col-12" for="example-file-input">depertment Icon Privew</label>
                    <div class="col-12">
                                ...
                                <label for="profile_photo" class="control-label">depertment icon *</label>
