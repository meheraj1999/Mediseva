...
<div class="col-md-12">
    <!-- Default Elements -->
    <div class="block">
        <a href="{{route('depertment.create')}}" >
            <button class="btn btn-success mt-2 mb-2 mr-2" style="float: right ">+ Add New </button>
        </a>
        <div class="panel-title"><h3>depertment List</h3></div>
    ...
    <table class="table table-bordered table-striped table-vcenter js-dataTable-full" style="width:100%">
        ...
        @foreach($depertmentData as $data)
            <tr>
                ...
                <td>
                    <a href="{{route('depertment.edit',$data->id)}}">
                    ...
                    <a class="btn btn-xs {{$data->status == 1 ? 'btn-success' :' btn-warning'}}"
                       href="{{route('depertment.status',$data->id)}}"><i class="fa fa-refresh"></i></a>
                    <a href="{{route('depertment.delete',$data->id)}}" data="{{$data->id}}"
                ...
                if (value) {
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            window.location.href = "/admin/depertment/" ;
                        },
                    });
                }
            });
