...
<div class="col-md-12">
    ...
    <div class="block">
        ...
        <div class="panel-title"><h3>Service List</h3></div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-xs {{$data->status == 1 ? 'btn-success' :' btn-warning'}}"
                       href="{{route('service.status',$data->id)}}"><i class="fa fa-refresh"></i></a>
                    <a href="{{route('service.delete',$data->id)}}" data="{{$data->id}}"
