...
<div class="col-md-12">
    ...
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Partner Slider </h3>
        ...
        <div class="block-content">
                ...
                <div class="form-group row">
                    <label class="col-12" for="example-text-input"><Title></Title></label>
                    <div class="col-md-12">
                ...
                <div class="form-group row">
                    <label class="col-12" for="example-file-input">Partner Icon Privew</label>
                    <div class="col-12">
                                ...
                                <label for="profile_photo" class="control-label">Partner icon *</label>
