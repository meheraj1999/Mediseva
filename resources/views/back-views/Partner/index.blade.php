...
<div class="col-md-12">
    ...
    <div class="block">
        ...
        <div class="panel-title"><h3>partner List</h3></div>
    ...
    <table class="table table-bordered table-striped table-vcenter js-dataTable-full" style="width:100%">
        ...
        @foreach($partnerData as $data)
            <tr>
                ...
                <td>
                    <a href="{{route('partner.edit',$data->id)}}">
                    ...
                    <a class="btn btn-xs {{$data->status == 1 ? 'btn-success' :' btn-warning'}}"
                       href="{{route('partner.status',$data->id)}}"><i class="fa fa-refresh"></i></a>
                    <a href="{{route('partner.delete',$data->id)}}" data="{{$data->id}}"
