...
@section('content')
           ...
           <main id="main-container">
            ...
            <center class="" style="margin-top: 184px;">
               ...
               <h2 style="font-size: 40px; font-width:bold;color: #fcf7e6; font-weigth:bold;">
                Mediseva<span style="color: white; font-size:70px;"></span> 

            </h2> 
            <a href="/" class="btn btn-info" target="_blank"> Visit Front End</a>
