...
@section('content')
@php($config=\App\Models\Setting::where('type','mainBanner')->first())
<div class="home-banner-area" style="background-image: url('{{$config->value}}');">
</div>
                            ...
                            <form>
                                <div class="form-group">
                                    <input type="text" name="" class="form-control"
                                        placeholder="Search doctors, clinis, hospital, etc.">
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="doctor-info-overview2" id="posts">
                                ...
                                <span><i class="ti-wallet"></i>Fees:{{$data->fees}}</span>
        ...
        <div class="row no-gutters">
            ...
            <div class="col-xl-6">
                <div
                    ...
                    <div class="info_button">
                        <a href="{{route('appoinment.create')}}" class="boxed-btn3-white">Make an Appointment</a>
                    </div>
                </div>
            </div>
        </div>
